...
class EmbeddingStore:
    ...
    def __init__(
        ...
        # The lab contract uses the deterministic in-memory implementation.
        # Keeping this disabled also avoids an optional ChromaDB installation
        # changing the behavior of the required exercises.
        self._use_chroma = False
